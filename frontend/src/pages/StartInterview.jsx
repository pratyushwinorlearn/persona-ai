...
export default function StartInterview({ onStart }) {
  ...
  useEffect(() => {
    ...
    const ctxGSAP = gsap.context(() => {
      ...
      // FIX: Use pinnedContainer so GSAP pins properly inside the scroller div.

      // Use anticipatePin:1 to eliminate the jump/lag when pinning starts.
...
#main-wrap {
  ...
  /* FIX 1: removed cursor:none — use the normal system arrow cursor */

  cursor:auto;

  -webkit-font-smoothing:antialiased;

  /* FIX 2: scroll-behavior smooth helps prevent jumpy scroll during pinned sections */
...
/* FIX 3: removed cursor-ring and cursor-dot CSS entirely */
...
/* FIX 4: all buttons inside the page use cursor:pointer not cursor:none */
